...
<script type="text/javascript">
	...
	function delProd(id){
		if(window.confirm("您确定要删除该商品吗?")){
			location.href = 
				"${ pageContext.request.contextPath }/ProdDelServlet?id="+id;
		}
	}
</script>
</head>
<body>
	...
	<c:forEach items="${list}" var="prod">
		<tr>
			...
			<td>
				<%-- 
				<a id="delProd" href="${ pageContext.request.contextPath }/ProdDelServlet?id=${prod.id}">删除</a> |
				 --%>
				 
				<a id="delProd" onclick="delProd(${prod.id})" 
